...
int count;// the counter of your choice (add,subtr,...).

double r1,r2; //the modulus under the root.

char choice,sign1,sign2,i1,i2;//for the question (y/n)/sign of the num +i or -i.
...

{
	...
	cout<<setw(51)<<"Mathematics Revisted Series"<<endl<<endl<<endl;
...
menu:
		...
		cout<<"\n\n\tYour choice = ";
			...
			case 8://Transform to trigonometric form
				...
				cout<<endl<<setw(56)<<"\"Transform to trigonometric form\"\n\n";
			...
			cout<<"\n\n\nDo you want to perform another operation on your numbers? (y/n) ";
...

{
	...
	cout << " SQUARE_ROOT(" << r1 << ")" << endl;

	cout<<"\n\tThe modulus of the second number (r2) = ";

	r2=((re2*re2)+(p*p));

	cout << " SQUARE_ROOT(" << r2 << ")" << endl;
...

{
	...
	cout<<"\n\tThe first number Z1 = " << " SQUARE_ROOT(" << r1 << ")*( COS "
	    <<g << " + " << "i" << " SIN " << g << " )\n";

	cout<<"\n\tThe second number Z2 = " << " SQUARE_ROOT(" << r2 << ")*( COS "
	    << h << " + " << "i" << " SIN " <<h<< " )\n";
...

{
	...
	cout<<"\n\tThe first number Z1 = (" << " SQUARE_ROOT[" << r1 << "], " << g << ")" << endl;

	cout<<"\n\tThe second number Z2 = (" << " SQUARE_ROOT[" << (r2) << "], " << h << ")" << endl;
...

{
	...
	cout<<"\n\tThe first number Z1 = " << " SQUARE_ROOT(" << r1 << ") e^ i " << g << endl;

	cout<<"\n\tThe second number Z2 = " << " SQUARE_ROOT(" << r2 << ") e^ i " << h << endl;
